...
import com.tourye.run.ILocationHelperServiceAIDL;
import com.tourye.run.ILocationServiceAIDL;
...
public class LocationHelperService extends Service {
    ...
    private void startBind() {
        final String locationServiceName = "com.tourye.run.LocationService";
        mInnerConnection = new ServiceConnection() {

            @Override
            public void onServiceDisconnected(ComponentName name) {
                RecordUtils.record("重启定位服务");
